...
const Navbar = () => {
    ...
    const { setToken, cartData, setRole,role } = useContext(ShopContext);
            ...
            <div className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <Link href="/" className="flex-shrink-0 text-2xl font-bold text-emerald-600 hidden md:flex items-center gap-2">
                        ...
                        {role === "admin" ? "EcoWear Admin":"EcoWear"}
                    </Link>
                    ...
                    <div className="hidden md:flex space-x-6 items-center">
                        ...
                        <Link href={role === "admin" ?"/pages/Order":"/pages/Cart"} className="relative text-gray-700 hover:text-emerald-600 transition flex items-center gap-1">
                            {
                                role === "admin" ? "Orders" :
                                    <>
